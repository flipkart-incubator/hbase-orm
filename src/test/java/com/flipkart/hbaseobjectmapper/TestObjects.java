...
public class TestObjects {
    ...
    public static final List<Triplet<HBRecord, String, Class<? extends IllegalArgumentException>>> invalidObjs = Arrays.asList(
            triplet(new Citizen("IND", -1, null, null, null, null, null, null, null, null, null), "all fields empty", AllHBColumnFieldsNullException.class),
            triplet(new Citizen(null, -2, "row key field null 1", null, null, null, null, null, null, null, null), "one row key field null (variant 1)", HBRowKeyFieldCantBeNullException.class),
            triplet(new Citizen("IND", null, "row key field null 2", null, null, null, null, null, null, null, null), "one row key field null (variant 2)", HBRowKeyFieldCantBeNullException.class),
            triplet(new Citizen(null, null, "row key fields null", null, null, null, null, null, null, null, null), "all row key fields null", HBRowKeyFieldCantBeNullException.class)
    );
}
