...
public class TestObjects {
    ...
    public static final List<Pair<HBRecord, String>> invalidObjs = Arrays.asList(
            pair(new Citizen("IND", -1, null, null, null, null, null, null, null, null, null), "all fields empty"),
            pair(new Citizen(null, -2, "row key field null 1", null, null, null, null, null, null, null, null), "one row key field null (variant 1)"),
            pair(new Citizen("IND", null, "row key field null 2", null, null, null, null, null, null, null, null), "one row key field null (variant 2)"),
            pair(new Citizen(null, null, "row key fields null", null, null, null, null, null, null, null, null), "all row key fields null")
    );
}
